<footer class="main-footer">
    ...
    &copy; 2022 <a href="https://www.iclienttech.com/">iCLIENTTECH</a>. All Rights Reserved.
  </footer>
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="<?php echo base_url(); ?>assets/images/avatar/2.jpg" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="<?php echo base_url(); ?>assets/images/avatar/3.jpg" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
