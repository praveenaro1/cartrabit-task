     ...
     <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="mr-auto">
               <h3 class="page-title">Edit Customer Service Details</h3>
      ...
      <section class="content" >
         ...
         <div class="row">
           <div class="col-12">
            <div class="box">
              <div class="box-body">
               <form enctype="multipart/form-data" method="post" action="<?php echo base_url('AdminController/updatebike/'.$bike->id); ?>">
                  <div class="form-body">
                     <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select class="form-control" name="active_status">
                                 <option value="1" <?php if($bike->active_status==1){ echo 'selected';} ?> >Accepted</option>
                                 <option value="0" <?php if($bike->active_status==0){ echo 'selected';} ?> >Pending</option>
                              </select>
                           </div>
                        </div>
                        <!--/span-->
