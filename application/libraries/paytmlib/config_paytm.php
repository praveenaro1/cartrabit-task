...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_MERCHANT_MID 		= "GxNJlp03743045333067";
	$PAYTM_MERCHANT_KEY 		= "cv_!Pz65LoFv#nH5";

	$PAYTM_CHANNEL_ID 		= "WEB";
	$PAYTM_INDUSTRY_TYPE_ID = "Retail";
	$PAYTM_MERCHANT_WEBSITE = "DEFAULT";

	$PAYTM_CALLBACK_URL 	= base_url()."payment_response";
	...
	$PAYTM_MERCHANT_MID 		= "pOLcmg36994522667571";
	$PAYTM_MERCHANT_KEY 		= "tUVzkzCs@nVMN#Iu";
